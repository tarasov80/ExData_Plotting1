...
png(filename = "plot2.png", width = 480, height = 480, units = "px", pointsize = 12, bg = "white",  type = c("windows"))
plot(x = pcdata$DateTime, y = pcdata$Global_active_power, xlab = "", ylab = "Global Active Power (kilowatts)", type = "l" )
dev.off()